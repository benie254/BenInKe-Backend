...
from benie_app.serializers_auth import ChangePasswordSerializer, PasswordResetRequestSerializer, PasswordResetSerializer, UpdateUserSerializer, UserSerializer
...
def activate(request, uidb64, token):
        ...
        if user is not None and account_activation_token.check_token(user, token):
            ...
            # return response 
            return redirect('http://benie.web.app/auth/confirmed/password/reset' + uid)
        else:
            Http404
            print("failure")
            response = Response()
